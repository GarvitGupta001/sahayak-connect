...
export default function PhoneHome() {
    return (
        <div className="bg-white text-slate-900">
            ...
            {/* Hero Section */}
            <section
                className="w-full min-h-screen bg-no-repeat bg-cover bg-center flex items-center px-4 pt-24" /* pt-24 to clear fixed nav */
                style={{
            ...
            >
                <div className="grid md:grid-cols-2 gap-10 w-full items-center">
                    <div>
                        ...
                        <div className="flex justify-center md:justify-start">
                            <button
                                ...
                                className="bg-slate-900 text-white px-8 md:px-16 py-3 rounded-full font-semibold hover:scale-105 transition"
                            >
                                Find and Apply Now
                            </button>
                        </div>
                    ...
                    <div className="relative block md:block mt-12 md:mt-0 min-h-[220px] md:min-h-0">
