...
export default function SignIn() {
  ...
  const [errorMessage, setErroMessage] = useState({ phone: "", password: "" });
      ...
      <Box className="h-screen my-4 mx-4 flex flex-col justify-start gap-25">
        ...
        <div className="">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <FormControl variant="outlined" error={!!errorMessage.phone}>
            ...
            <FormControl variant="outlined" error={!!errorMessage.password}>
